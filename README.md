...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fluidfoam-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6628&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fluidfoam-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fluidfoam` can be installed with:

```
conda install fluidfoam
```

It is possible to list all of the versions of `fluidfoam` available on your platform with:
